package com.xma.jupiter.external;
...
public class TwitchClient {
    private static final String TOKEN = "Bearer n8n5h9jsfv1saadi2pp5tygeivhnfo";
...
//            Game[] games = mapper.readValue(data, Game[].class);
    ...
    public List<Game> topGames(int limit) throws TwitchException {
        ...
        String respondebody = searchTwitch(url);
        return getGameList(respondebody);
    }
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            ...
            //"https://api.twitch.tv/helix/games?name= among us";
    ...
    private String buildSearchURL(String url, String gameID, int limit) {
        ...
        // url = "https://api.twitch.tv/helix/streams?game_id=%s&first=%s";
    ...
    private List<Item> getItemList(String data) throws TwitchException {
        ObjectMapper mapper = new ObjectMapper();
        try {
//            Item[] games = mapper.readValue(data, Game[].class);
    ...
    private List<Item> searchStreams(String gameId, int limit) throws TwitchException {
        ...
        String data = searchTwitch(url); //return data represented as string
        List<Item> streams = getItemList(data); // transform data to list of ITEM
