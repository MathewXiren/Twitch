...
import com.xma.jupiter.entity.FavoriteRequestBody;
...
//        FavoriteRequestBody body = mapper.readValue(request.getReader(), FavoriteRequestBody.class);//json string to object
