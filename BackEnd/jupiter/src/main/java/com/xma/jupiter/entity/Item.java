...
@JsonIgnoreProperties(ignoreUnknown = true) //ignore the unknown key
@JsonInclude(JsonInclude.Include.NON_NULL)  // ignore the null value when return the json file
...
public class Item {
    ...
    @JsonAlias({ "user_name" }) // both name cast to broadcasterName
