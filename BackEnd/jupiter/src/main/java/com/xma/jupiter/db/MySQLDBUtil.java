...
public class MySQLDBUtil {
    private static final String INSTANCE = "winter-project.cjchfib6ytfl.us-east-2.rds.amazonaws.com";
    ...
    public static String getMySQLAddress() throws IOException {
        ...
        return String.format("jdbc:mysql://%s:%s/%s?user=%s&password=%s&autoReconnect=true&serverTimezone=EST&createDatabaseIfNotExist=true",
